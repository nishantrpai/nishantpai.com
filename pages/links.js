        ...
        <div className="container py-12">
          <div className="space-y-2">
            {validProjects
              ...
              .map((d) => (
              <div key={d.title} className="flex items-center p-4 border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-900/50 transition-colors">
